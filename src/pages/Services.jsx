...
const servicesData = [
    ...
    { id: 14, category: "Skin Care & Facials", title: "Diamond Microderm", price: "$130", time: "45min", img: "https://images.unsplash.com/photo-1515377905703-c4788e51af15?q=80&w=2070&auto=format&fit=crop", desc: "Medical-grade diamond tip exfoliation for resurfaced skin.", tag: "Premium", status: "Available" },
    { id: 15, category: "Skin Care & Facials", title: "Chemical Peel", price: "$150", time: "40min", img: "https://images.unsplash.com/photo-1490481658045-3646a7ec9363?q=80&w=2070&auto=format&fit=crop", desc: "Professional grade chemical peel for deep cellular renewal.", status: "Available" },
    { id: 16, category: "Skin Care & Facials", title: "Oxygen Infusion", price: "$140", time: "55min", img: "https://images.unsplash.com/photo-1512290901844-399a9a30f14a?q=80&w=2070&auto=format&fit=crop", desc: "Pure oxygen combined with vitamins for immediate glow.", status: "Available" },
    ...
    { id: 8, category: "Hair Styling", title: "Keratin Treatment", price: "$200", time: "120min", img: "https://images.unsplash.com/photo-1562322140-8baeececf3df?q=80&w=2069&auto=format&fit=crop", desc: "Smooth, frizz-free hair that lasts for months.", status: "Available" },
    { id: 9, category: "Hair Styling", title: "Creative Cut", price: "$65", time: "45min", img: "https://images.unsplash.com/photo-1595476108010-b4d1f102b1b1?q=80&w=2000&auto=format&fit=crop", desc: "Expert precision cutting tailored to your face shape.", status: "Available" },
    ...
    { id: 24, category: "Hair Styling", title: "Full Color", price: "$120", time: "90min", img: "https://images.unsplash.com/photo-1605497746471-881cba59048a?q=80&w=1974&auto=format&fit=crop", desc: "Complete hue transformation with premium Ammonia-free dyes.", status: "Available" },
    ...
    { id: 30, category: "Nails & Pedicure", title: "Paraffin Wax", price: "$35", time: "25min", img: "https://images.unsplash.com/photo-1519415510236-855906a20bb2?q=80&w=2070&auto=format&fit=crop", desc: "Soothing warm wax for super soft hands and feet.", status: "Available" },
    ...
    { id: 44, category: "Massage Therapy", title: "Thai Stretch", price: "$115", time: "90min", img: "https://images.unsplash.com/photo-1600244498308-f4ee6610738d?q=80&w=2070&auto=format&fit=crop", desc: "Traditional assisted yoga stretching for flexibility.", status: "Available" },
